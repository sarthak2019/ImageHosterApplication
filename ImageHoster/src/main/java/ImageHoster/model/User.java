...
public class User {
    ...
    /* The 'users' table is referenced by the 'comment' table.
       ...
       'comment' table associated to that particular record in 'users' table will be deleted first and then the record
    ...
    /* Generated getter method for the variable comments present inside User class. */

    public void setComments(List<Comment> comments) {
        this.comments = comments;
    }
    /* Generated setter method for the variable comments present inside User class. */
